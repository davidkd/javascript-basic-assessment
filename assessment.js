...
function getValueOfProperty(object, propertyName) {
...
function outside(temperature, humidity, cloudiness) {
	...
	if (temperature > 80 && humidity > 40 && cloudiness === 0) {
		return "I'm all sweat";
	}
		else if (temperature < 40 && humidity === 0 && cloudiness > 60) {
